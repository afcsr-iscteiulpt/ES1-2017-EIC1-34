...
public class File_Scanner {
	...
	/**
	 * este m�todo faz o scan do ficheiro das regras
	 * @param path
	 * @return
	 */
	...
	/**
	 * este m�todo faz o scan dos ficheiros de ham e spam
	 * @param path
	 * @return
	 */
	...
	/**
	 * este m�todo faz o scan do ficheiro da configura��o previamente salvada
	 * @param path
	 * @return
	 */
	...
	public static ArrayList<Rule> deciferResults(String rules_path) throws FileNotFoundException {
		//-----------------------------------------------------------------------------------------------------------
		//distinguir qual � a melhor configura��o das obtidas
		...
		//cria a lista de regras actualizada com os pesos da melhor configura��o
	...
	/**
	 * retorna a melhor configura��o encontrada
	 * @return
	 * @throws FileNotFoundException
	 */
